...
export default function PurchaseReturnTransaction() {
  ...
  const [vendorCustomer, setVendorCustomer] = useState('[CASH IN HAND] (111)');
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await createTransaction({
        ...
        credit_account_id: Number(expense.id),
        amount: grandTotal,
  ...
  const handleReset = () => {
    ...
    setTransactionDate('');
    setNarration('');
    setVendorCustomer('[CASH IN HAND] (111)');
    setStockRows([
      { id: 1, selectType: '', selectProduct: '', curQty: '0', unit: '', rate: '0', qty: '', total: '0' }
    ]);
    setDiscount('0');
