...
const ProductionTab = ({ refreshKey }: Props) => {
  ...
  const tiles = [
    {
      ...
      value: fmtNum(milkInfo?.today_total_milk, ' L')
    },
    {
      icon: '📅',
      label: t('main.dashboard.productionTab.yesterday'),
      value: fmtNum(milkInfo?.yesterday_total_milk, ' L')
    },
    {
      icon: '📊',
      label: t('main.dashboard.common.avgPerCow'),
      value: fmtNum(milkInfo?.avg_milk_per_cow, ' L')
    },
    {
      icon: '🧮',
      label: t('main.dashboard.productionTab.rangeTotal'),
      value: fmtNum(milkInfo?.currentFilterMilk, ' L')
    }
  ]
  ...
  return (
    <>
      ...
      <GlassCard
        title={t('main.dashboard.productionTab.trendTitle')}
        right={
            ...
            {FILTERS.map(f => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {t(`main.dashboard.productionTab.filters.${f}`)}
                  </AppText>
                </TouchableOpacity>
              )
            })}
      ...
      >
        {loading ? (
          ...
          <EmptyState title={t('main.dashboard.productionTab.empty')} icon="📈" />
        )}
      </GlassCard>
    </>
  )
